...
Rust enforces this distinction to ensure:

- Predictable behavior
- No accidental returns
- Strong compile-time guarantees
- Safer, more readable code

Mastering expressions vs statements is a **major step** toward understanding ownership, borrowing, and lifetimes.
